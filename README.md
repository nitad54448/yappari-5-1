...
On the DRT graph, the experimental Zi is scaled to 100 in absolute value and shown for comparison with calculated DRT plot which is also scaled to 100. The DRT procedure may help to detect a proper electrical circuit; if you want to used it, there is a lot of good publications describing the procedure and purpose.
