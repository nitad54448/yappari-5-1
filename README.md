# YAPPARI
version october 27th, 2024, release 5.1.82.1
...
## Changes 
   - Oct 27, 2024 : In the case of constrained fit, when editing the parameters, only values whitin limits will be accepted. Release 5.1.82.1 (updated 4th of nov 2024, changed some code to inlining with pre-allocation clones, fitting is now faster).
