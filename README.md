...
Criteria for selecting the optimal value are included in this program. You can either use [DRT search lambda](https://github.com/nitad54448/yappari-5-1/blob/main/README.md#drt-search-lambda) command or use __Advanced commands__ by using _search_lambda_ or _explore_lambda_ command if you want to save all data.
