...
On the DRT graph, the experimental Zr and Zi are plotted together with the reconstructed impedances from the DRT data and a probability of distribution function.
