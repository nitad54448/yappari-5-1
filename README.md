...
Criteria for selecting the optimal value are included in this program. You can either use [DRT search lambda](https://github.com/nitad54448/yappari-5-1/blob/main/README.md#drt-search-lambda) command or use "Advanced commands" by using search_lambda or explore_lambda command if you want to save all data.
